...
Perform BTE calculations using kALDo for Germanium. Like for the previous step, create a folder `fc_DFT/` and input the calculated `espresso.ifc2` and `FORCE_CONSTANTS_3RD_D3Q` and the provided `CONTROL` file.
