...
- Execute the following commands to obtain the 3rd order force constants `FORCE_CONSTANTS_3RD_D3Q`. This requires the `FILDRHO/` folder created from `ph.x` in step 1.  
